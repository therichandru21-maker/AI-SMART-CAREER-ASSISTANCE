...
The system employs a high-concurrency Node.js / Express reverse proxy architecture integrated with Vite client rendering and Google's GROQ generative intelligence backbone. 

2. Security & Credential Isolation
- API Token Protection: All generative AI credentials are securely encapsulated within server-side environment parameters (process.env.GROQ_API_KEY No API secrets or model headers are ever exposed to the client bundle.
